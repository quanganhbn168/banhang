...
<div class="card">
    ...
    <form action="{{ route('admin.slides.update', $slide) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div id="image-group" style="{{ $type == \App\Models\Slide::TYPE_AFTER_BEFORE ? 'display: none;' : '' }}">
                <x-form.image-input
                    name="image"
                    label="Ảnh slide"
            ...
            <div id="before-after-group" style="{{ $type == \App\Models\Slide::TYPE_AFTER_BEFORE ? '' : 'display: none;' }}">
                <x-form.image-input
                    name="before_image"
                    label="Ảnh Trước"
                    :value="$image['before'] ?? ''"
